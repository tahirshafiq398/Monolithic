...
# ===== SRN (MANDATORY FOR PDF & SCREENSHOTS) =====
SRN = "PES2UG23CS639"
print("SRN:", SRN)
# ===============================================
...
def events(request: Request, user: str):
    ...
    # Optimized: removed unnecessary computation loop
...
def register_event(event_id: int, user: str):
    if event_id == 404:
        1 / 0  # intentional crash (PDF requirement)
...
def my_events(request: Request, user: str):
    ...
    # Optimized: removed unnecessary delay loop
...
def checkout(request: Request):
    ...
    return templates.TemplateResponse(
        "checkout.html", {"request": request, "total": total, "user": ""}
    )
